...
#ifndef FCODEC_PLUGIN_COMMON_TAGS_H
#define FCODEC_PLUGIN_COMMON_TAGS_H
...
enum struct Tag : uint32_t {
   ...
   /* -------------------- FCODEC specific tag -------------------- */
    REQUIRED_IN_BUFFER_CNT,          ///< uint32_t, required buffer count of plugin; read only tag   
    SURFACE_PIXFORMAT,
    SURFACE_SCALE_TYPE,
    SURFACE_ROTATION,          
};
...
#endif // FCODEC_PLUGIN_COMMON_TAGS_H
