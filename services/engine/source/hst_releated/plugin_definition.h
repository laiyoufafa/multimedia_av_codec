...
enum struct Status : int32_t {
    ...
    ERROR_INCOMPATIBLE_VERSION = -3,
                        ///< Incompatible version, may occur during plugin registration or function calling.
...
struct Register {
     ...
     *  @retval CSERR_PLUGIN_ALREADY_EXISTS: The plugin already exists in plugin registered.
     *  @retval CSERR_INCOMPATIBLE_VERSION: Incompatible version during plugin registration.
     */
...
struct PackageRegister : Register {
    ...
    *  @retval CSERR_PLUGIN_ALREADY_EXISTS: The package or plugins already exists.
     *  @retval CSERR_INCOMPATIBLE_VERSION: Incompatible plugin interface version or api version.
     */
