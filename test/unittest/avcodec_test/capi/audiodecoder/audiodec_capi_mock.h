...
#ifndef AUDIO_DEC_CAPI_MOCK_H
#define AUDIO_DEC_CAPI_MOCK_H
...
namespace OHOS {
namespace Media {
class AudioDecCapiMock : public AudioDecMock {
public:
    explicit AudioDecCapiMock(OH_AVCodec *codec) : codec_(codec) {}
    ~AudioDecCapiMock() = default;
