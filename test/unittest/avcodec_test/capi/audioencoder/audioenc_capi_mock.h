...
#ifndef AUDIO_ENC_CAPI_MOCK_H
#define AUDIO_ENC_CAPI_MOCK_H
...
namespace OHOS {
namespace Media {
class AudioEncCapiMock : public AudioEncMock {
public:
    explicit AudioEncCapiMock(OH_AVCodec *codec) : codec_(codec) {}
    ~AudioEncCapiMock() = default;
...
private:
    ...
    void SetCallback(OH_AVCodec *codec, std::shared_ptr<AVCodecCallbackMock> cb);
