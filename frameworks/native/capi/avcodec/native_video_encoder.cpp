...
struct OH_AVCodec *OH_VideoEncoder_CreateByMime(const char *mime)
{
    ...
    AVCODEC_LOGD("Video encoder create by mime successful");
    return object;
}
...
struct OH_AVCodec *OH_VideoEncoder_CreateByName(const char *name)
{
    ...
    AVCODEC_LOGD("Video encoder create by name successful");
    return object;
}
...
OH_AVErrCode OH_VideoEncoder_Destroy(struct OH_AVCodec *codec)
{
    ...
    delete codec;
    AVCODEC_LOGD("Video encoder destroy successful");
    return AV_ERR_OK;
}
...
OH_AVErrCode OH_VideoEncoder_Configure(struct OH_AVCodec *codec, struct OH_AVFormat *format)
{
    ...
    AVCODEC_LOGD("Video encoder configure successful");
    return AV_ERR_OK;
}
...
OH_AVErrCode OH_VideoEncoder_Prepare(struct OH_AVCodec *codec)
{
    ...
    AVCODEC_LOGD("Video encoder prepare successful");
    return AV_ERR_OK;
}
...
OH_AVErrCode OH_VideoEncoder_Start(struct OH_AVCodec *codec)
{
    ...
    AVCODEC_LOGD("Video encoder start successful");
    return AV_ERR_OK;
}
...
OH_AVErrCode OH_VideoEncoder_Stop(struct OH_AVCodec *codec)
{
    ...
    AVCODEC_LOGD("Video encoder stop successful");
    return AV_ERR_OK;
}
...
OH_AVErrCode OH_VideoEncoder_Flush(struct OH_AVCodec *codec)
{
    ...
    AVCODEC_LOGD("Video encoder flush successful");
    return AV_ERR_OK;
}
...
OH_AVErrCode OH_VideoEncoder_Reset(struct OH_AVCodec *codec)
{
    ...
    AVCODEC_LOGD("Video encoder reset successful");
    return AV_ERR_OK;
}
...
OH_AVErrCode OH_VideoEncoder_GetSurface(OH_AVCodec *codec, OHNativeWindow **window)
{
    ...
    *window = CreateNativeWindowFromSurface(&surface);
    ...
    AVCODEC_LOGD("Video encoder get surface successful");
    return AV_ERR_OK;
}
...
OH_AVFormat *OH_VideoEncoder_GetOutputDescription(struct OH_AVCodec *codec)
{
    ...
    AVCODEC_LOGD("Video encoder get output description successful");
...
OH_AVErrCode OH_VideoEncoder_FreeOutputData(struct OH_AVCodec *codec, uint32_t index)
{
    ...
    AVCODEC_LOGD("Video encoder free output data successful");
    return AV_ERR_OK;
}
...
OH_AVErrCode OH_VideoEncoder_NotifyEndOfStream(OH_AVCodec *codec)
{
    ...
    AVCODEC_LOGD("Video encoder notify end of stream successful");
    return AV_ERR_OK;
}
...
OH_AVErrCode OH_VideoEncoder_SetParameter(struct OH_AVCodec *codec, struct OH_AVFormat *format)
{
    ...
    AVCODEC_LOGD("Video encoder set parameter successful");
    return AV_ERR_OK;
}
    ...
    struct OH_AVCodec *codec, struct OH_AVCodecAsyncCallback callback, void *userData)
{
    ...
    try {
        ...
        AVCODEC_LOGE("Video encoder set callback failed! Exc: %{public}s", exc.what());
    ...
    AVCODEC_LOGD("Video encoder set callback successful");
    return AV_ERR_OK;
}
...
OH_AVErrCode OH_VideoEncoder_PushInputData(struct OH_AVCodec *codec, uint32_t index, OH_AVCodecBufferAttr attr)
{
    ...
    AVCODEC_LOGD("Video encoder push input data successful");
    return AV_ERR_OK;
}
